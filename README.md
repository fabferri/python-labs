...
- **AI**
   - [Azure OpenAI Model Availability Checker](https://github.com/fabferri/python-labs/tree/main/ai-fondry-openai-models-availability)
   - [Azure AI Foundry multi-model deployment and interactive chat](https://github.com/fabferri/python-labs/tree/main/ai-foundry-chat-with-agent-01)
